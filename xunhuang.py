...
args.img_path = '/content/3333.jpg' # path to input photo
...
args.max_m_strokes = 10000 # max number of strokes
args.max_divide = 30 # divide an image up-to max_divide x max_divide patches
...
args.renderer_checkpoint_dir = '/content/checkpoints_G_oilpaintbrush/' # dir to load the pretrained neu-renderer
args.lr = 0.005 # learning rate for stroke searching
args.output_dir = '/content/drive/My Drive/output/' # dir to save painting results
